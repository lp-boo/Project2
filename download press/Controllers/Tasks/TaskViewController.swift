...
extension TaskViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: idTasksCell.self, for: indexPath) as! TaskTableViewCell
...
extension TaskViewController: PressReaadyTaskButtonProtocol {
