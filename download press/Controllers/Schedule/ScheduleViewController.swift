...
class ScheduleViewController:  UIViewController {
  ...
  private var calendarHeightConstraint: NSLayoutConstraint!
    ...
    var scheduleArray: Results<SchedulModel>!
    ...
    override func viewDidLoad() {
        ...
        scheduleArray = localRealm.objects(SchedulModel.self)
...
//        tableView.reloadData()
    ...
    @objc private func addButtonTapped() {
        let scheduleOption = ScheduleOptionsViewController()
...
// MARK: Swipe
    ...
    scheduleArray = localRealm.objects(SchedulModel.self).filter(compound).sorted(byKeyPath: "scheduleTime")
    
//    var scheduleArray = localRealm.objects(SchedulModel.self).sorted(byKeyPath: "scheduleTime").sorted(byKeyPath: "scheduleTime")
//
        tableView.reloadData()
...
extension ScheduleViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: idScheduleCell.self, for: indexPath) as! ScheduleTableViewCell
